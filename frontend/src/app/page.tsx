...
export default function LandingPage() {
  return (
    <main className="editorial-shell px-5 py-5 md:px-10 md:py-8">
      <header className="mx-auto flex max-w-7xl items-center justify-between border-b editorial-rule pb-5">
        ...
        <nav className="flex items-center gap-5 text-xs font-bold">
          ...
          <Link className="button-primary py-2.5" href="/register">
            Open mailbox <ArrowUpRight size={14} />
          </Link>
        </nav>
      </header>
      <section className="mx-auto grid max-w-7xl gap-14 py-20 md:py-28 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
        <div>
          <p className="eyebrow mb-7 flex items-center gap-2">
            <span className="status-dot" /> postal simulation
          </p>
          <h1 className="serif max-w-3xl text-6xl leading-[.95] tracking-[-.055em] sm:text-8xl">
            Letters that take time to arrive.
          </h1>
          <p className="mt-8 max-w-lg text-base leading-7 text-[#6d6d6d]">
            Digital Postal turns messages into journeys. Pick a real place,
            write something worth keeping, and let distance decide when it
            arrives.
          </p>
        ...
        <div className="relative flex min-h-[530px] items-center justify-center overflow-hidden px-3 py-12">
          ...
          <div className="relative z-10 w-full max-w-md rotate-[-1deg] border border-[#141414] bg-white p-6 shadow-[10px_12px_0_rgba(20,20,20,.08)] md:p-8">
            <div className="flex items-start justify-between border-b editorial-rule pb-6">
              <div>
                <p className="eyebrow">dispatch note / 001</p>
            ...
            <div className="py-10">
              <div className="flex items-center justify-between text-xs font-bold">
                <span>Delhi</span>
                <span className="text-[#6d6d6d]">1,080 km</span>
                <span>Muzaffarpur</span>
              </div>
              <div className="relative my-7 h-px bg-[#141414]">
                <span className="absolute left-[48%] top-[-4px] h-2 w-2 bg-[#5d43bb]" />
              </div>
            ...
            <div className="flex justify-between border-t editorial-rule pt-5 text-[10px] uppercase tracking-[.12em] text-[#6d6d6d]">
              <span>content sealed</span>
              <span>arrives in 18 hours</span>
            </div>
          </div>
        </div>
      </section>
      <footer className="mx-auto flex max-w-7xl justify-between border-t editorial-rule pt-4 text-[10px] font-bold uppercase tracking-[.14em] text-[#6d6d6d]">
        ...
        <span>Real distance. Real time.</span>
      </footer>
    </main>
  );
}
